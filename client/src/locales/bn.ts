export const bn = {
  ...
  cashbox: {
    ...
    resetCashbox: 'ক্যাশবক্স রিসেট করুন',
    resetWarning: 'সতর্কতা: এটি সমস্ত ক্যাশবক্স ডেটা এবং লেনদেন মুছে ফেলবে। এই পদক্ষেপ পূর্বাবস্থায় আনা যায় না।',
    resetConfirm: 'আপনি কি ক্যাশবক্স রিসেট করতে নিশ্চিত?',
    resetSuccess: 'ক্যাশবক্স সফলভাবে রিসেট করা হয়েছে'
  },
  ...
  transactions: {
    ...
    descriptionPlaceholder: 'বিল পাদটীকার জন্য সংক্ষিপ্ত বিবরণ...',
    itemNamePlaceholder: 'পণ্যের নাম',
    qtyPlaceholder: '১',
    pricePlaceholder: '০.००',
  ...
  customers: {
    ...
    customerStatement: 'গ্রাহক বিবৃতি',
    summary: 'সারসংক্ষেপ',
    totalTransactions: 'মোট লেনদেন',
    totalPaymentsReceived: 'মোট পেমেন্ট গৃহীত',
    totalCharges: 'মোট খরচ',
    autoGeneratedStatement: 'এটি একটি স্বয়ংক্রিয় তৈরি বিবৃতি। অনুসন্ধানের জন্য অনুগ্রহ করে সহায়তার সাথে যোগাযোগ করুন।',
    removeItemTitle: 'আইটেম সরান',
    loading: 'লোড হচ্ছে...',
    welcome: 'স্বাগতম'
  },
  ...
  app: {
    loading: 'লোড হচ্ছে...',
    preparingWorkspace: 'আপনার কর্মক্ষেত্র প্রস্তুত করছি...',
    msDidarLogo: 'এম/এস দিদার ট্রেডিং লোগো',
    welcome: 'স্বাগতম',
    close: 'বন্ধ করুন'
  },
  ...
  suppliers: {
    ...
    // Print statement
    supplierStatement: 'সরবরাহকারী বিবৃতি',
    summary: 'সারসংক্ষেপ',
    totalTransactions: 'মোট লেনদেন',
    totalPaymentsMade: 'মোট পরিশোধ',
    totalPurchases: 'মোট ক্রয়',
    autoGeneratedStatement: 'এটি একটি স্বয়ংক্রিয় তৈরি বিবৃতি। অনুসন্ধানের জন্য অনুগ্রহ করে সহায়তার সাথে যোগাযোগ করুন।',

    // Placeholders
    amountPlaceholder: '০',
    paymentDescriptionPlaceholder: 'কিসের জন্য পেমেন্ট...',
  ...
  billGenerator: {
    ...
    customerSupplierPlaceholder: 'গ্রাহক/সরবরাহকারীর নাম',
    cash: 'নগদ',
    card: 'কার্ড',
    bank: 'ব্যাংক',
    due: 'বকেয়া',
    ...
    enterQuantity: 'পরিমাণ লিখুন',
    enterRate: 'দর লিখুন',
    discountAmount: 'ছাড় পরিমাণ',
    transportFee: 'পরিবহন খরচ',
    labourFee: 'শ্রম খরচ',
    total: 'মোট'
  }
};
