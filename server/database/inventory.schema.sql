-- Inventory/Transaction Database Schema
-- This database contains ALL business logic: users, customers, suppliers, transactions
...
-- Cashbox table (tracks current cash balance)
...
-- Cashbox Transactions table (deposit/withdrawal history)
